...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    if (managedObjectModel_ != nil) {
		...
		//    NSString *modelPath = [[NSBundle mainBundle] pathForResource:@"thc_ipad" ofType:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [NSURL fileURLWithPath: [[self applicationDocumentsDirectory] stringByAppendingPathComponent: @"thc_ipad.sqlite"]];
